...
test.describe('Create Dashboard View A', function () {
    ...
    test.it('Should be possible to create a new view', function () {
        ...
        driver.findElement(By.xpath('//input[@id = "title"]')).sendKeys('Title A');
        driver.findElement(By.xpath('//input[@id = "subtitle"]')).sendKeys('Subtitle A');
        ...
        driver.wait(until.elementLocated(By.xpath('//span[@id = "listViews"]//span[. = "Title A"]')), timeout);
        driver.sleep(pause);
    });
